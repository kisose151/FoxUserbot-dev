...
LANGUAGES = {
    ...
    "ru": {
        ...
        "no_module": "<emoji id='5210952531676504517'>❌</emoji> <b>Укажите ссылку, ответьте на файл .py или названием модуля</b>",
    ...
    "ua": {
        ...
        "no_module": "<emoji id='5210952531676504517'>❌</emoji> <b>Вкажіть посилання, відповісте на .py або назвою модуля</b>",
